...
const sendResetEmail = async (email: string, token: string) => {
  ...
  await transporter.sendMail({
    ...
    html: `<p>Please copy the link and <a href="http://l18.119.105.184/api/v1/reset/reset-password?token=${token}">reset your password</a>. This link expires in 1 hour.</p>`,
  });
};
